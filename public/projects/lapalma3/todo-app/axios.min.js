...
!(function (e, t) {
  ...
  function n(t) {
    ...
    return (
      (n[("undefined" != typeof Symbol && Symbol.iterator) || "@@iterator"] =
        function () {
          return this;
        }),
      (n.next = function (e) {
  ...
  function s(e, t, n) {
    return (
      ...
      (function (e, t) {
        ...
        e,
        y() ? Reflect.construct(t, n || [], p(e).constructor) : t.apply(e, n)
      )
    );
  }
  function c(e, t) {
                    ...
                    if ((u || (o = "next"), (t = i[o]))) {
                      ...
                      1 === u && (t = i.return) && t.call(i),
                        u < 2 &&
                          ...
                          (u = 1));
                    i = e;
                  } else if ((t = (l = d.n < 0) ? s : n.call(r, d)) !== a)
                    break;
                } catch (t) {
                  (i = e), (u = 1), (s = t);
                } finally {
            ...
            Re.forEach(n, function (n, i) {
              !0 ===
                (!(Re.isUndefined(n) || null === n) &&
                  o.call(t, n, Re.isString(i) ? i.trim() : i, r, l)) &&
                e(n, r ? r.concat(i) : [i]);
            }),
            f.pop();
        }
  ...
  var De = (function () {
    ...
    Me =
      Ie &&
      (!qe || ["ReactNative", "NativeScript", "NS"].indexOf(qe.product) < 0),
    ze =
  ...
  function Qe(e) {
    return !1 === e || null == e ? e : Re.isArray(e) ? e.map(Qe) : String(e);
  }
    ...
    return l(
      ...
      [
        ...
        },
        {
          key: "accessor",
          value: function (e) {
            var t = (this[Xe] = this[Xe] = { accessors: {} }).accessors,
              n = this.prototype;
            function r(e) {
              var r = $e(e);
              t[r] ||
      ...
      ? {
          write: function (e, t, n, r, o, i, a) {
            if ("undefined" != typeof document) {
              ...
              Re.isNumber(n) &&
                u.push("expires=".concat(new Date(n).toUTCString())),
  ...
  function ft(e, t, n) {
    var r,
      o = !(
        "string" == typeof (r = t) && /^([a-z][a-z\d+\-.]*:)?\/\//i.test(r)
      );
    return e && (o || 0 == n)
      ? (function (e, t) {
  ...
  var pt,
    ht = function (e) {
      ...
      if (
        ...
        (r && Re.isFunction(r) && (r = r(t)), r || (!1 !== r && st(t.url)))
      ) {
        var f = o && i && ct.read(i);
        f && a.set(o, f);
      }
      ...
      function (e) {
        return new Promise(function (t, n) {
          ...
          if (
            ...
            (y.onabort = function () {
              y &&
                (n(new Te("Request aborted", Te.ECONNABORTED, e, y)),
                (y = null));
            }),
          ...
          (s.cancelToken || s.signal) &&
            ...
            s.signal &&
              (s.signal.aborted ? r() : s.signal.addEventListener("abort", r)));
          var g,
            w,
            O =
              ((g = s.url),
          ...
          O && -1 === Je.protocols.indexOf(O)
            ? n(
                new Te("Unsupported protocol " + O + ":", Te.ERR_BAD_REQUEST, e)
              )
            : y.send(c || null);
        });
      },
        ...
        var r,
          ...
          i = function (e) {
            if (!r) {
              ...
              o.abort(
                t instanceof Te ? t : new rt(t instanceof Error ? t.message : t)
              );
            }
          },
          a =
            ...
            setTimeout(function () {
              (a = null),
                i(new Te("timeout of ".concat(t, "ms exceeded"), Te.ETIMEDOUT));
            }, t),
          u = function () {
            e &&
              (a && clearTimeout(a),
              ...
              for (;;)
                switch ((e.p = e.n)) {
                  ...
                  case 3:
                    ...
                    return (l = f.value), e.d(w(n(r(bt(l, o)))), 4);
                  case 4:
                    (i = !1), (e.n = 2);
                    break;
                  case 5:
                ...
                for (;;)
                  switch (e.n) {
                    ...
                    case 2:
                      ...
                      return (
                        (n = new r(Je.origin, { method: "POST", body: t })),
                        (e.n = 3),
                        n.arrayBuffer()
                      );
                    case 3:
                    ...
                    case 5:
                      if (
                        (Re.isURLSearchParams(t) && (t += ""), !Re.isString(t))
                      ) {
                        e.n = 7;
                        break;
                      }
                  ...
                  switch ((e.p = e.n)) {
                    ...
                    case 8:
                      if (
                        ...
                        !Q ||
                          "TypeError" !== Q.name ||
                          !/Load failed|fetch/i.test(Q.message))
                      ) {
                        e.n = 9;
                        break;
                      }
                    ...
                    case 9:
                      throw Te.from(Q, Q && Q.code, t, P, Q && Q.response);
                    case 10:
                      return e.a(2);
                  }
              },
    ...
    Pt = function (e) {
      for (
        ...
        (t = i[a]),
          void 0 === (n = u.get(t)) && u.set(t, (n = a ? new Map() : At(r))),
          (u = n);
      return n;
    };
  Pt();
  ...
  var Ct = {
    getAdapter: function (e, t) {
      for (
        var n, r, o = (e = Re.isArray(e) ? e : [e]).length, i = {}, a = 0;
        a < o;
        a++
      ) {
        var u = void 0;
        if (
          ((r = n = e[a]),
          !Nt(n) && void 0 === (r = _t[(u = String(n)).toLowerCase()]))
        )
              ...
              void 0 !== r &&
                It.assertOptions(
                  r,
                  {
                    ...
                    legacyInterceptorReqResOrdering: qt.transitional(
                      qt.boolean
                    ),
                  },
                  !1
